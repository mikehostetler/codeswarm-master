define([
		...
		"underscore",
		"utils/timestamp",
		"text!views/header.tpl",
		"text!views/signup.tpl",
		"text!views/login.tpl",
		"text!views/menu.tpl",
		"text!views/projects.tpl",
		"text!views/projects_table.tpl",
		"text!views/project.tpl",
		"text!views/builds.tpl",
		"text!views/logview.tpl",
		"text!views/tokens.tpl",
		"text!views/github_repos.tpl",
		"text!views/plugins.tpl",
		"text!views/tags.tpl",
		"text!views/builds_by_tag.tpl"
	],
