...
module.exports.sockets = {
  ...
  onConnect: function(session, socket) {
    ...
    socket.on('join project', function(project) {
      console.log('socket joining project', project);
      socket.join(project);
    });


    socket.on('leave project', function(project) {
      console.log('socket leaving project', project);
